...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      { en: "200–300+ live channels", ne: "२००–३०० भन्दा बढी लाइभ च्यानलहरू" },
      { en: "On-demand movies & shows", ne: "अन-डिमान्ड चलचित्र र शोहरू" },
      { en: "Sports, News, Kids, Music channels", ne: "खेलकुद, समाचार, बालबालिका, संगीत च्यानलहरू" },
  ...
  },
  {
    ...
    descNe: "हाम्रो संयुक्त इन्टरनेट + IPTV प्याकेजले दुवैको सुविधा पाउनुहोस्। एउटै किफायती बन्डलमा अति द्रुत फाइबर इन्टरनेट र प्रिमियम IPTV मनोरञ्जन उपभोग गर्नुहोस्।",
    features: [
