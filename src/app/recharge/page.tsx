...
const paymentMethods = [
  {
    ...
    steps: [
      { en: "Open the eSewa app on your smartphone.", ne: "आफ्नो स्मार्टफोनमा eSewa एप खोल्नुहोस्।" },
      ...
      { en: "Enter your Customer ID or registered phone number.", ne: "आफ्नो ग्राहक ID वा दर्ता गरिएको फोन नम्बर प्रविष्ट गर्नुहोस्।" },
      { en: "Verify the payment amount and your account details.", ne: "भुक्तान रकम र आफ्नो खाताको विवरण प्रमाणित गर्नुहोस्।" },
      { en: "Enter your eSewa PIN or use biometric authentication.", ne: "आफ्नो eSewa PIN प्रविष्ट गर्नुहोस् वा बायोमेट्रिक प्रमाणीकरण प्रयोग गर्नुहोस्।" },
      { en: 'Tap "Pay Now" to complete the transaction.', ne: '"Pay Now" थिचेर कारोबार पूरा गर्नुहोस्।' },
      { en: "Save or screenshot the payment receipt for your records.", ne: "आफ्नो अभिलेखका लागि भुक्तान रसिद सेभ गर्नुहोस् वा स्क्रिनसट लिनुहोस्।" },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { en: "Enter your Customer ID or registered mobile number.", ne: "आफ्नो ग्राहक ID वा दर्ता गरिएको मोबाइल नम्बर प्रविष्ट गर्नुहोस्।" },
      ...
      { en: "Confirm with your Khalti PIN or MPIN.", ne: "आफ्नो Khalti PIN वा MPIN सँग पुष्टि गर्नुहोस्।" },
  ...
  },
  {
    ...
    steps: [
      { en: "Open your bank's mobile banking app (NIC Asia, Nabil, Rastriya Banijya, etc.).", ne: "आफ्नो बैंकको मोबाइल बैंकिङ एप खोल्नुहोस् (NIC Asia, Nabil, राष्ट्रिय बाणिज्य, आदि)।" },
      ...
      { en: "Enter your Customer ID or registered contact number.", ne: "आफ्नो ग्राहक ID वा दर्ता गरिएको सम्पर्क नम्बर प्रविष्ट गर्नुहोस्।" },
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-amber-700 text-sm mt-0.5">
                ...
                <span className="lang-ne">भुक्तान गर्दा सधैँ आफ्नो <strong>ग्राहक ID</strong> वा <strong>दर्ता गरिएको फोन नम्बर</strong> समावेश गर्नुहोस्। कुनै पनि भुक्तान समस्याका लागि WhatsApp वा फोनमार्फत हाम्रो बिलिङ टोलीसँग सम्पर्क गर्नुहोस्।</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              ...
              <span className="lang-ne">आफ्नो मनपर्दो डिजिटल भुक्तान विधि छान्नुहोस् र तलको चरण-दर-चरण गाइड पालना गर्नुहोस्।</span>
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                descNe: "कम्तिमा ३० दिनका लागि भुक्तानको प्रमाणको रूपमा भुक्तान रसिद वा स्क्रिनसट सधैँ सेभ गर्नुहोस्।",
                color: "text-[#0B7F3A]",
                bg: "bg-green-50",
              },
              {
                ...
                descNe: "तपाईंको भुक्तान सही खातामा जमा भएको सुनिश्चित गर्न सधैँ सही ग्राहक ID प्रविष्ट गर्नुहोस्।",
              ...
              },
              {
                ...
                descNe: "आफ्नो रसिदसहित हाम्रो बिलिङ टोलीसँग सम्पर्क गर्नुहोस्। भुक्तानहरू सामान्यतया २–४ व्यापार घण्टाभित्र अपडेट हुन्छन्।",
                color: "text-[#2298D4]",
                bg: "bg-sky-50",
              },
            ].map((tip, i) => (
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-blue-200 text-base leading-relaxed mb-6">
                  ...
                  <span className="lang-ne">यदि तपाईंलाई भुक्तान, बिलिङ प्रश्नहरू, वा आफ्नो खातामा मद्दत चाहिन्छ भने, हाम्रो टोली सहायता गर्न तयार छ।</span>
                </p>
