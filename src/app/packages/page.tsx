      ...
      <section className="bg-gradient-to-br from-[#071A3D] via-[#25468F] to-[#071A3D] py-20">
        <div className="container-custom text-center text-white">
          ...
          <p className="text-blue-200 text-lg max-w-xl mx-auto">
            Choose the perfect plan for your home or business. No hidden fees, no surprises.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          {loading ? (
            <div className="flex items-center justify-center h-40">
              <div className="w-8 h-8 border-4 border-[#25468F] border-t-transparent rounded-full animate-spin"></div>
            </div>
          ) : filtered.length === 0 ? (
            <div className="text-center py-20">
              ...
              <Link href="/contact" className="mt-4 inline-flex items-center gap-2 text-[#25468F] font-semibold hover:underline">
                Contact us for custom plans <ArrowRight size={16} />
              </Link>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="p-7 flex-1 flex flex-col">
                      <p className="text-xs font-bold text-[#0B7F3A] uppercase tracking-widest mb-1">
                        {tabs.find(t => t.id === pkg.category)?.label}
                      </p>
        ...
        <div className="container-custom max-w-3xl">
          <div className="bg-gradient-to-r from-[#25468F] to-[#071A3D] rounded-3xl p-8 text-white text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/faq" className="px-6 py-3 bg-white/10 border border-white/30 text-white font-bold rounded-xl hover:bg-white/20 transition-all">
                View FAQ
              </Link>
            </div>
          </div>
