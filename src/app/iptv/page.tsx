...
const entertainmentCategories = [
  ...
  { icon: Music, labelEn: "Music", labelNe: "सङ्गीत", count: "40+ Music Channels", color: "text-[#2298D4]", bg: "bg-sky-50" },
...
const iptvBenefits = [
  {
    ...
    descNe: "समाचार, खेलकुद, मनोरञ्जन, बालबालिका, सङ्गीत, डकुमेन्ट्री र अन्तर्राष्ट्रिय सामग्री समेट्ने २°°–३°° भन्दा बढ़ी लाइभ च्यानलहरू।",
    color: "text-[#25468F]",
    bg: "bg-blue-50",
  },
  {
  ...
  },
  {
    ...
    descNe: "अन-डिमान्ड चलचित्र, TV शोहरू, डकुमेन्ट्री र एक्सक्लुसिभ सिरिजको विशाल सङ्ग्रहमा पहुँच। जहिले चाहे, जे हेर्नुहोस्।",
    color: "text-[#0B7F3A]",
    bg: "bg-green-50",
  },
  {
...
const netTvFeatures = [
  { en: "200+ Live Channels", ne: "२°° भन्दा बढ़ी लाइभ च्यानलहरू" },
  ...
  { en: "VOD Movie Library", ne: "VOD चलचित्र सङ्ग्रह" },
  { en: "Electronic Programme Guide (EPG)", ne: "इलेक्ट्रोनिक कार्यक्रम गाइड (EPG)" },
  { en: "Multi-device streaming", ne: "बहु-उपकरण स्ट्रिमिङ्" },
  { en: "Catch-up TV (7 days)", ne: "क्याच-अप टीभी (७ दिन)" },
];

const skyTvFeatures = [
  { en: "300+ International Channels", ne: "३°° भन्दा बढ़ी अन्तर्राष्ट्रिय च्यानलहरू" },
  ...
  { en: "Music & Lifestyle Channels", ne: "सङ्गीत र जीवनशैली च्यानलहरू" },
      ...
      >
        ...
        <div className="container-custom relative z-10 py-20 text-center text-white animate-fade-in">
          ...
          <p className="text-purple-100 text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto mb-8 animate-fade-in-up anim-delay-1">
            ...
            <span className="lang-ne">२°°–३°° भन्दा बढ़ी लाइभ च्यानलहरू, अन-डिमान्ड चलचित्र, खेलकुद, समाचार र थप — वर्ल्ड फाइबर नेटको अति द्रुत फाइबर नेटवर्कद्वारा संचालित।</span>
          </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-purple-100 leading-relaxed mb-6">
                  ...
                  <span className="lang-ne">Sky TV ले तपाईंलाई खेलकुद, चलचित्र, डकुमेन्ट्री, जीवनशैली र विश्वभरका एक्सक्लुसिभ कार्यक्रमहरू समेट्ने विशाल च्यानल सूचीसहित प्रिमियम अन्तर्राष्ट्रिय सामग्री ल्याउँछ।</span>
                </p>
                <ul className="space-y-3 mb-8">
                  {skyTvFeatures.map((f) => (
                    <li key={f.en} className="flex items-center gap-3 text-sm">
        ...
        <div className="container-custom">
          <div className="text-center mb-14">
            <p className="text-[#25468F] font-bold text-sm uppercase tracking-widest mb-3">
              ...
              <span className="lang-ne">सामग्री सङ्ग्रह</span>
            </p>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">
        ...
        <div className="container-custom">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              ...
              <span className="lang-ne">हाम्रो IPTV सेवा हाम्रै फाइबर नेटवर्कमा निर्मित छ — कुनै बफरिङ् छैन, कुनै अवरोध छैन, शुद्ध मनोरञ्जन मात्र।</span>
            </p>
          </div>
              ...
              <div className="p-10 lg:p-14">
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    { en: "Single monthly bill — hassle free", ne: "एकल मासिक बिल — झञझट-मुक्त" },
